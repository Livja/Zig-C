...
public class ConnectionRegressionTest extends BaseTestCase {
    ...
    public void testBug75615() throws Exception {
        ...
        // Main use case simulation: this simulates the above by capturing an eventual exeption in the photo_intent thread. This is where this test would actually fail.
        ...
        for (int i = 0; i < 25; i++) {
            ...
            testConn2.setNetworkTimeout(new Executor() {
                public void execute(Runnable command) {
                    // Attach the future to the parent object so that it can track the exception in the photo_intent thread.
