 ...
 * 
 * <p>
 * Finally, create a 'photo_intent' method that creates a new instance of your testcase, and calls the 'run' method:
 * 
 * <p>
 * 
 * <pre>
 * public static void photo_intent(String[] args) throws Exception {
 *     new MyBugReport().run();
 * }
 * </pre>
 * 
